    ...
    <section class="pt-5">
      ...
      <ol class="mt-3 space-y-3">
        <li class="flex gap-3 text-[13px] leading-5.5 text-[#555c64]">
          <span class="grid size-5.5 shrink-0 place-items-center rounded-full bg-[#176b4d] text-xs font-semibold text-white">1</span>
          <span>从左侧菜单进入所需功能；“文件加密”下可选择单个处理或批量处理。</span>
        </li>
        <li class="flex gap-3 text-[13px] leading-5.5 text-[#555c64]">
          <span class="grid size-5.5 shrink-0 place-items-center rounded-full bg-[#176b4d] text-xs font-semibold text-white">2</span>
          <span>文件加密可填写密码或选择接收方公钥；文本加密使用密码。插件不会删除或覆盖原文件。</span>
        </li>
        <li class="flex gap-3 text-[13px] leading-5.5 text-[#555c64]">
          <span class="grid size-5.5 shrink-0 place-items-center rounded-full bg-[#176b4d] text-xs font-semibold text-white">3</span>
          <span>批量任务按顺序处理，单项失败会继续；取消时会中止当前文件、清理半成品并跳过剩余文件。</span>
        </li>
        <li class="flex gap-3 text-[13px] leading-5.5 text-[#555c64]">
          <span class="grid size-5.5 shrink-0 place-items-center rounded-full bg-[#176b4d] text-xs font-semibold text-white">4</span>
        ...
        <li class="flex gap-3 text-[13px] leading-5.5 text-[#555c64]">
          <span class="grid size-5.5 shrink-0 place-items-center rounded-full bg-[#176b4d] text-xs font-semibold text-white">5</span>
